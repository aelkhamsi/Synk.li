...
let LoginBoxComponent = class LoginBoxComponent {
    constructor(fb, authService, router, _snackBar) {
        this.fb = fb;
        this.authService = authService;
        this.router = router;
...
let SignupBoxComponent = class SignupBoxComponent {
    constructor(fb, authService, router, _snackBar) {
        this.fb = fb;
        this.authService = authService;
        this.router = router;
...
SignupBoxComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
...
module.exports = ".logo {\n  width: 80px;\n  height: 75px;\n  margin-top: 2%;\n}\n\n.hide-mobile {\n  display: none;\n}\n\nheader {\n  display: flex;\n  justify-content: space-between;\n}\n\n.menu {\n  margin-top: 100%;\n  cursor: pointer;\n}\n\n.illustration {\n  width: 40%;\n}\n\nh1, .subhead {\n  position: relative;\n  z-index: 3;\n}\n\n.subhead {\n  font-size: 0.8em;\n  padding: 0 2em;\n}\n\n.core-section-2 {\n  display: none;\n}\n\n.buttons {\n  display: flex;\n  justify-content: space-evenly;\n}\n\n.red-container {\n  width: 100%;\n  background-color: #F24423;\n  color: white;\n  margin-top: 10%;\n  padding: 2% 1%;\n  font-size: 1em;\n  border-top-left-radius: 40px;\n  -webkit-transform: skewY(-2deg);\n          transform: skewY(-2deg);\n}\n\n.red-container:before {\n  content: \"\";\n  width: 40px;\n  height: 40px;\n  background: #F24423;\n  position: absolute;\n  top: -39px;\n  right: 7px;\n  z-index: 1;\n}\n\n.red-container:after {\n  content: \"\";\n  width: 80px;\n  height: 80px;\n  background: white;\n  position: absolute;\n  border-radius: 50px;\n  top: -80px;\n  right: 7px;\n  z-index: 2;\n}\n\n.red-container ul, .red-container h1 {\n  -webkit-transform: skewY(2deg);\n          transform: skewY(2deg);\n}\n\n.red-container-subhead {\n  padding-left: 5%;\n  padding-right: 9%;\n}\n\n.light-grey-container {\n  background: whitesmoke;\n  margin-top: -8%;\n  padding-top: 8%;\n  padding-bottom: 6%;\n}\n\n.cta {\n  display: block;\n  font-weight: bold;\n  width: 30%;\n  margin: auto;\n  color: white;\n  background: #F24423;\n  margin-top: 5%;\n  margin-bottom: 5%;\n  padding: 3% 5%;\n  border-radius: 25px;\n  z-index: 5;\n}\n\n.cta:hover {\n  background: var(--secondary-color);\n  transition: 0.5s;\n}\n\n.grey-container {\n  color: white;\n  background: #4d4c4c;\n  margin-top: -2%;\n  padding: 2%;\n}\n\n.footer-links {\n  font-size: 0.7em;\n  color: white;\n  display: flex;\n  justify-content: space-evenly;\n}\n\nnav ul {\n  position: fixed;\n  width: 40%;\n  top: 0;\n  right: 0;\n  text-align: left;\n  background: #333;\n  height: 100%;\n  z-index: 10;\n  padding-top: 1em;\n}\n\nnav ul a {\n  color: white;\n  display: block;\n  width: 100%;\n  padding: 1em 2em;\n  background-color: #3a3a3a;\n}\n\nnav ul a:hover {\n  background-color: #444;\n  transition: 0.7s;\n}\n\n.exit-btn {\n  margin-bottom: 1em;\n  text-align: right;\n  padding: 0 1.1em;\n}\n\n.exit-btn img {\n  cursor: pointer;\n}\n\n@media only screen and (min-width: 650px) {\n  .illustration {\n    width: 35%;\n  }\n\n  h1 {\n    font-size: 1.8em;\n  }\n\n  .subhead {\n    font-size: 0.9em;\n    padding: 0 2em;\n  }\n\n  .cta {\n    width: 25%;\n  }\n\n  .red-container {\n    margin: 0;\n  }\n}\n\n@media only screen and (min-width: 800px) {\n  .container {\n    width: 80%;\n    margin: auto;\n  }\n\n  h1 {\n    font-size: 2.2em;\n  }\n\n  .subhead {\n    font-size: 1em;\n    padding: 0 2em;\n  }\n\n  .red-container ul {\n    display: flex;\n  }\n}\n\n@media only screen and (min-width: 1024px) {\n  .show-desktop {\n    display: block;\n  }\n\n  .hide-desktop {\n    display: none;\n  }\n\n  nav ul {\n    position: inherit;\n    width: auto;\n    background: none;\n    height: auto;\n    display: flex;\n  }\n\n  nav ul li a {\n    color: black;\n    background-color: inherit;\n    padding: 1em 1.5em;\n  }\n\n  nav ul li a:nth-child(2) {\n    background: red;\n  }\n\n  .container {\n    width: 65%;\n    margin: 1% auto 1% auto;\n  }\n\n  .core-section-2 {\n    display: flex;\n    margin-top: 7%;\n  }\n\n  .core-section-1 {\n    display: none;\n  }\n\n  h1 {\n    font-size: 1.8em;\n  }\n\n  .subhead {\n    font-size: 1em;\n    padding: 0 2em;\n  }\n\n  .title-subhead {\n    margin: auto;\n  }\n\n  .scroll {\n    margin: auto;\n    width: 30px;\n    -webkit-animation: move 1s infinite alternate;\n            animation: move 1s infinite alternate;\n    margin-bottom: 8%;\n  }\n\n  @-webkit-keyframes move {\n    0% {\n      -webkit-transform: translateY(0px);\n              transform: translateY(0px);\n    }\n    100% {\n      -webkit-transform: translateY(30px);\n              transform: translateY(30px);\n    }\n  }\n\n  @keyframes move {\n    0% {\n      -webkit-transform: translateY(0px);\n              transform: translateY(0px);\n    }\n    100% {\n      -webkit-transform: translateY(30px);\n              transform: translateY(30px);\n    }\n  }\n}\n\n@media only screen and (min-width: 1400px) {\n  h1 {\n    font-size: 2.5em;\n  }\n\n  .subhead {\n    font-size: 1.2em;\n    padding: 0 2em;\n  }\n\n  .cta {\n    width: 20%;\n  }\n\n  .logo {\n    width: 90px;\n    height: 85px;\n  }\n}\n\n@media only screen and (min-width: 1600px) {\n  h1 {\n    font-size: 2.7em;\n  }\n\n  .cta {\n    width: 15%;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
let DashboardPage = class DashboardPage {
    constructor(fb, authService, roomService, router, _snackBar) {
        this.fb = fb;
        this.authService = authService;
...
let RoomPage = class RoomPage {
    constructor(fb, route, _snackBar, router) {
        this.fb = fb;
        this.route = route;
        this._snackBar = _snackBar;
        this.router = router;
    ...
    connectSocket() {
        this.socket = socket_io_client__WEBPACK_IMPORTED_MODULE_4__(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].SOCKET_URI, { query: `roomId=${this.roomId}&username=${this.username}` });
...
let RoomComponent = class RoomComponent {
    constructor(route, roomService, router, _snackBar) {
        this.route = route;
        this.roomService = roomService;
        this.router = router;
        this._snackBar = _snackBar;
...
let AuthService = class AuthService {
    constructor(http, jwtHelper) {
        ...
        this.SERVER_URI = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].SERVER_URI;
        this.httpOptions = {
    ...
    login(email, password) {
        ...
        return this.http.post('auth/login', data, this.httpOptions);
    }
    //POST:  login
    signup(username, email, password) {
        ...
        return this.http.post('auth/signup', data, this.httpOptions);
    }
    //TOKEN
...
let RoomService = class RoomService {
    constructor(http) {
        this.http = http;
        this.SERVER_URI = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].SERVER_URI;
        this.httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'Content-Type': 'application/json',
                'x-access-token': ''
    ...
    createRoom() {
        ...
        return this.http.post('room/create-room', {}, this.httpOptions);
    }
    joinRoom(roomId) {
        const data = {
            roomId: roomId
        ...
        return this.http.post('room/join-room', data, this.httpOptions);
    }
};
